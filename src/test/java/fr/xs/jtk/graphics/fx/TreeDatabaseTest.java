...
import fr.xs.jtk.graphics.fx.api.database.TreeDatabaseFX;
import fr.xs.jtk.graphics.fx.nodes.DatabaseModel;

public class TreeDatabaseTest extends ApplicationFX {
	TreeDatabaseFX<DatabaseModel> theDatabaseView = null;
    ...
    public Scene scene() {
		...
		theDatabaseView = new TreeDatabaseFX<DatabaseModel>(DatabaseModel.class, null, viewModel);

...
import fr.xs.jtk.communication.interfaces.IBroadcastListener;

public abstract class BroadcastListenerPattern implements IBroadcastListener {
	...
	BroadcastListenerPattern(int _port) {
		m_Port = _port;
	}

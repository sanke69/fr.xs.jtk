 ...
 */
package fr.xs.jtk.graphics.fx3d.shapes.primitives;

import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_COLORS;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_COLOR_PALETTE;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_DENSITY_FUNCTION;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_DIFFUSE_COLOR;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_PATTERN;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_PATTERN_SCALE;
import static fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.DEFAULT_UNIDIM_FUNCTION;
...
import fr.xs.jtk.graphics.fx3d.geometry.Face3;
import fr.xs.jtk.math.type.geom.Point3D;
import fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.MeshHelper;
import fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TextureMode;
...
import fr.xs.jtk.graphics.fx3d.shapes.primitives.helper.TriangleMeshHelper.TextureType;
import fr.xs.jtk.graphics.fx3d.utils.Palette.ColorPalette;

...
import fr.xs.jtk.graphics.fx3d.events.CloseCutawayEvent;
...
public final class Cutaway extends VBox {
    ...
    public EulerCamera camera = new EulerCamera();
    ...
    public void setFirstPersonNavigationEabled(boolean b) {
        ...
        imageView.setOnMouseDragged((MouseEvent me) -> {
            ...
            if (me.isPrimaryButtonDown()) {
            	camera.ry.setAngle(((camera.ry.getAngle() + mouseDeltaX * modifierFactor * modifier * 2.0) % 360 + 540) % 360 - 180); // +
            	camera.rx.setAngle(((camera.rx.getAngle() - mouseDeltaY * modifierFactor * modifier * 2.0) % 360 + 540) % 360 - 180); // -                

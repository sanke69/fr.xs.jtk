 ...
 */
package fr.xs.jtk.graphics.fx3d.shapes.complex.cloth;
...
public class ClothMesh extends MeshView {
        ...
        this.setOnMousePressed((MouseEvent me) -> {
            if (me.isPrimaryButtonDown()) {
                ...
                if (pr.getIntersectedFace() != -1) {
                    ...
                    if (me.isControlDown()) {
                        points.get(vals[0]).setOldPosition((Point3D) points.get(vals[0]).getOldPosition().add(0, 0, 25));
                        points.get(vals[2]).setOldPosition((Point3D) points.get(vals[2]).getOldPosition().add(0, 0, 25));
                        points.get(vals[4]).setOldPosition((Point3D) points.get(vals[4]).getOldPosition().add(0, 0, 25));
                    } else {
                        points.get(vals[0]).setOldPosition((Point3D) points.get(vals[0]).getOldPosition().add(0, 0, -25));
                        points.get(vals[2]).setOldPosition((Point3D) points.get(vals[2]).getOldPosition().add(0, 0, -25));
                        points.get(vals[4]).setOldPosition((Point3D) points.get(vals[4]).getOldPosition().add(0, 0, -25));
    ...
    */
    ...
    public void addForce(Point3D f){
        setAccumulatedForces((Point3D) getAccumulatedForces().add(f));
    }

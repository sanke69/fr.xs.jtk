...
public class CsvWriter {
	...
	/**
	 * Creates a {@link fr.xs.jtk.format.csv.CsvWriter CsvWriter} object using a file
	...
	/**
	 * Creates a {@link fr.xs.jtk.format.csv.CsvWriter CsvWriter} object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	...
	/**
	 * Creates a {@link fr.xs.jtk.format.csv.CsvWriter CsvWriter} object using an

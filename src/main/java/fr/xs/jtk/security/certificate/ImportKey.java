...
public class ImportKey  {
    ...
    public static void generateJavaKeyStore(String _pemKeyFile, String _pemCertFile, String _jksFile) {
        ...
        String keystorename = _jksFile;
        String keyfile = _pemKeyFile;
        String certfile = _pemCertFile;
